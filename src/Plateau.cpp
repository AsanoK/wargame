...
void Plateau::deployerUnitesInitiales()
{
	...
	Cavalier *c1=new Cavalier(cases[0][NBCASES/2-NB_TROUPES_DEPART/2-2],p1);
	p1.ajouterUnite(*c1);
	cases[0][NBCASES/2-NB_TROUPES_DEPART/2-2].setUnite(c1);
	Cavalier *c2=new Cavalier(cases[0][NBCASES/2-NB_TROUPES_DEPART/2+2],p1);
	p1.ajouterUnite(*c2);
	cases[0][NBCASES/2-NB_TROUPES_DEPART/2+2].setUnite(c2);

	Artillerie *a1=new Artillerie(cases[0][NBCASES/2-NB_TROUPES_DEPART/2-1],p1);
	p1.ajouterUnite(*a1);
	cases[0][NBCASES/2-NB_TROUPES_DEPART/2-1].setUnite(a1);
	Artillerie *a2=new Artillerie(cases[0][NBCASES/2-NB_TROUPES_DEPART/2+1],p1);
	p1.ajouterUnite(*a2);
	...
	Cavalier *c3=new Cavalier(cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2-2],p2);
	p2.ajouterUnite(*c3);
	cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2-2].setUnite(c3);
	Cavalier *c4=new Cavalier(cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2+2],p2);
	p2.ajouterUnite(*c4);
	cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2+2].setUnite(c4);
	Artillerie *a3=new Artillerie(cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2-1],p2);
	p2.ajouterUnite(*a3);
	cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2-1].setUnite(a3);
	Artillerie *a4=new Artillerie(cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2+1],p2);
	p2.ajouterUnite(*a4);
	cases[NBCASES-1][NBCASES/2-NB_TROUPES_DEPART/2+1].setUnite(a4);
}
