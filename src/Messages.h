 ...
 */
#define MSSG_ATTAQUE_REALISEE "l'assaut est termin̩"
#define MSSG_DEPLAC_REALISE "d̩placement effectu̩"
#define MSSG_CIBLE_EN_VIE "Les troupes ennemies ont tenues malgr̩ vos assauts"
#define MSSG_CIBLE_DETRUITE "Vos troupes ont pr̩valu, l'assaut est une r̩ussite!"
